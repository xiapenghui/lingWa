  ...
  <div class="app-container">
    <div class="search">
      <el-row :gutter="20">
        ...
        <el-col :span="4">
          <el-col :span="24">
            <el-tooltip class="item" effect="dark" :enterable="false" content="包含禁状态的缺陷类型" placement="top-start">
              <el-checkbox v-model="pagination.ShowBanned">包含禁状态的缺陷类型</el-checkbox>
            </el-tooltip>
          </el-col>
        </el-col>
    ...
    <el-dialog :close-on-click-modal="false" :visible.sync="dialogFormVisible" :title="dialogType === 'edit' ? $t('permission.EditCompany') : $t('permission.addCompany')">
      <el-form ref="ruleForm" v-loading="editLoading" :model="ruleForm" :rules="rules" label-width="120px" label-position="left">
        <el-form-item label="缺陷类型编号" prop="DefectTypeNum"><el-input v-model.trim="ruleForm.DefectTypeNum" placeholder="缺陷类型编号" clearable /></el-form-item>

        <el-form-item label="缺陷类型名称" prop="DefectTypeName"><el-input v-model.trim="ruleForm.DefectTypeName" placeholder="缺陷类型编号" clearable /></el-form-item>

  ...
  <div class="app-container">
    <div class="search">
      <el-row :gutter="20">
        ...
        <el-col :span="4">
          <el-col :span="24">
            <el-tooltip class="item" effect="dark" :enterable="false" content="包含禁用状态的缺陷" placement="top-start">
              <el-checkbox v-model="pagination.ShowBanned">包含禁用状态的缺陷</el-checkbox>
            </el-tooltip>
          </el-col>
        </el-col>

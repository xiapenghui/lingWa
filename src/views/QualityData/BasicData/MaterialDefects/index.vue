  ...
  <div class="app-container">
    <div class="search">
      <el-row :gutter="20">
        ...
        <el-col :span="4">
          <el-col :span="24">
            <el-tooltip class="item" effect="dark" :enterable="false" content="包含禁用状态的产品" placement="top-start">
              <el-checkbox v-model="pagination.ShowBanned">包含禁用状态的产品</el-checkbox>
            </el-tooltip>
          </el-col>
        </el-col>
...
import { GetDictionary, BaseProList, GetMaterialList } from '@/api/BasicData'
  ...
  methods: {
    ...
    handleDelete(row) {
      this.$confirm(this.$t('permission.errorInfo'), this.$t('permission.errorTitle'), {
        ...
        .then(() => {
          QuaProduDelete({ IQCCode: row.IQCCode }).then(res => {
            if (res.IsPass === true) {
              this.$message({
                type: 'success',

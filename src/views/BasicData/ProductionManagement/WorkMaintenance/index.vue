  ...
  <div class="app-container">
    <div class="search">
      <el-row :gutter="20">
        ...
        <el-col :span="4">
          <el-col :span="24">
            <el-tooltip class="item" effect="dark" :enterable="false" content="包含禁状态的工序" placement="top-start">
    ...
    >
      ...
      <el-table-column align="center" :label="$t('permission.operations')" fixed="right" width="150">
        <template slot-scope="scope">
          ...
          <el-tooltip v-if="scope.row.Status == true" class="item" effect="dark" :enterable="false" content="启用" placement="top-start">
    ...
    <el-dialog v-dialogDrag :close-on-click-modal="false" :visible.sync="dialogFormVisible" :title="dialogType === 'edit' ? $t('permission.editBasePro') : $t('permission.addBasePro')">
      <el-form ref="ruleForm" v-loading="editLoading" :model="ruleForm" :rules="rules" label-width="100px" label-position="left">
        <el-form-item label="工序编号"><el-input v-model.trim="ruleForm.ProcessNum" placeholder="工序编号" onkeyup="value=value.replace(/[\u4e00-\u9fa5/\s+/]/ig,'')" clearable /></el-form-item>
        ...
        <el-form-item label="工序描述"><el-input v-model.trim="ruleForm.Description" placeholder="工序描述" clearable /></el-form-item>

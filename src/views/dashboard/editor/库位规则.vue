<template>
  <div class="app-container">
    ...
    >
      ...
      <el-tlumn align="center" label="仓库编号" width="150" prop="WarehouseNum" sortable :show-overflow-tooltip="true">
        <template slot-scope="scope">
          {{ scope.row.WarehouseNum }}
        </template>
        </el-table-column>

        <el-tolumn align="center" label="仓库名称" width="150" prop="WarehouseName" sortable :show-overflow-tooltip="true">
          <template slot-scope="scope">
          ...
          <el-table-calign="center" label="产品" width="150" prop="RegionName" sortable :show-overflow-tooltip="true">
            <template slot-scope="scope">
              {{ scope.row.RegionName }}
            </template>
            </el-table-column>

            <el-table-column "center" label="库存容量" width="150" prop="RegionName" sortable :show-overflow-tooltip="true">
              <template slot-scope="scope">
                {{ scope.row.RegionName }}
              </template>
            </el-table-column>

            <el-table-column align="r&quot;" label="优先级" width="150" prop="RegionName" sortable :show-overflow-tooltip="true">
              <template slot-scope="scope">
                {{ scope.row.RegionName }}
              </template>
            </el-table-column>

            <el-table-column align="centeel="状态" width="150" prop="RegionName" sortable :show-overflow-tooltip="true">
              <template slot-scope="scope">
                {{ scope.row.RegionName }}
              </template>
            </el-table-column>
          ...
          </el-table-calign="center"></el-tolumn></el-tlumn></el-table>

    ...
    >
      ...
      <el-table-column align="center" label="抽检方案编号" width="200" prop="RuleNum" sortable :show-overflow-tooltip="true">
        <template slot-scope="scope">
          <span v-if="isLook"> {{ scope.row.RuleNum }}</span>
          <!-- <el-input v-if="Look" v-model="scope.row.SpareName" clearable /> -->
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" label="抽检方案描述" width="200" prop="Description" sortable :show-overflow-tooltip="true">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" label="采样数量" width="150" prop="SampleQty" sortable :show-overflow-tooltip="true">
        <template slot-scope="scope">
          {{ scope.row.SampleQty }}
        </template>
      </el-table-column>
...
// import { QuaBaseList, EquBaseAdd, EquBaseDelete, EquBaseModify, EquBaseModifyStatus } from '@/api/DeviceData'
import { QuaBaseList } from '@/api/QualityData'
const fixHeight = 260
export default {
  name: 'IncomingInsp',
  ...
  methods: {
    ...
    getList() {
      ...
      QuaBaseList(this.pagination).then(res => {
        debugger

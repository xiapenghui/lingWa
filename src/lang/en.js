export default {
  ...
  permission: {
    ...
    lookPermission: 'Look',
    title: 'Role Name',
    titleInfo: 'Please Enter The Role Name',
    name: 'Role Name',
    user: 'User',
    time: 'Creation Time',
    ...
    ProcessRoute: 'Route Name',
    ProcessRouteInfo: 'Please input routing name',
    inclusionRoute: 'Contains the routing name under disabled condition',
    edition: 'Routing Version',
    editionInfo: 'Please input process version',
    EditRoute: 'Edit',
    lookRoute: ' look',
    handleRoute: ' handle',
    SpecificationsRoute: 'Enable',
    deleteRoute: 'delete',
    addRoute: 'Add route',
    exportRoute: 'Export route',
    importRoute: 'Import route',
    ProcessRouteDetail: 'Process route details',
    descriptionRoute: 'Process route description',
    changeRoute: 'Select process route',
    submit: 'Submit',
    addRepai: 'Add Maintenance',
    addTechnology: 'Add Operation',
    EditRouter: 'Edit Route',
    addRouter: 'Add Route',
    // 截止
